...
#define GST_S3_UPLOADER_CONFIG_DEFAULT_PROP_AWS_SDK_REQUEST_TIMEOUT -1
#define GST_S3_UPLOADER_CONFIG_DEFAULT_PROP_CACHE_NUM_PARTS 0
#define GST_S3_UPLOADER_CONFIG_DEFAULT_PROP_AWS_SDK_RETRY_MAX 10
#define GST_S3_UPLOADER_CONFIG_DEFAULT_PROP_AWS_SDK_RETRY_SCALE 25
...
typedef struct {
  ...
  gint32 aws_sdk_request_timeout_ms;
  gint32 aws_sdk_retry_max;
  gint32 aws_sdk_retry_scale;
  gint cache_num_parts;
} GstS3UploaderConfig;
...
#define GST_S3_UPLOADER_CONFIG_INIT (GstS3UploaderConfig) { \
  ...
  GST_S3_UPLOADER_CONFIG_DEFAULT_PROP_CACHE_NUM_PARTS \
}
